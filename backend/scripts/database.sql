-- ============================================
-- FIESTALANDIA - BASE DE DATOS LIMPIA Y SEGURA
-- ============================================

CREATE DATABASE IF NOT EXISTS fiestalandia CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE fiestalandia;
...
CREATE TABLE IF NOT EXISTS clientes (
    ...
    rol ENUM('cliente', 'admin', 'proveedor') NOT NULL DEFAULT 'cliente',
    creado_en TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS solicitudes_registro_servicio (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS carrito (
    ...
    cantidad INT NOT NULL DEFAULT 1,
    evento_id INT NULL,
    evento_nombre VARCHAR(120) NULL,
    fecha_agregado TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (cliente_id) REFERENCES clientes(id) ON DELETE CASCADE,
    FOREIGN KEY (servicio_id) REFERENCES servicios(id) ON DELETE CASCADE,
    FOREIGN KEY (evento_id) REFERENCES eventos(id) ON DELETE SET NULL,
    UNIQUE KEY unique_cliente_servicio_evento (cliente_id, servicio_id, evento_id)
);

-- ============================================
-- ÍNDICES PARA OPTIMIZACIÓN
-- ============================================
-- Nota: Si los índices ya existen, ignorar los errores de "Duplicate key name"
...
CREATE INDEX idx_carrito_servicio ON carrito(servicio_id);
CREATE INDEX idx_carrito_evento ON carrito(evento_id);

-- ============================================
-- VISTAS PARA CONSULTAS OPTIMIZADAS
-- ============================================

-- Servicios públicos (para todos los usuarios)
...
('Administrador', 'admin@fiestalandia.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin')
